...
void PairMLIP::settings(int narg, char **arg)
{
  ...
  if (narg == (2+4))
  {
        ...
        bd_l[0]=utils::numeric(FLERR,arg[2],false,lmp);
        bd_l[1]=utils::numeric(FLERR,arg[3],false,lmp);
        bd_r[0]=utils::numeric(FLERR,arg[4],false,lmp);
        bd_r[1]=utils::numeric(FLERR,arg[5],false,lmp);
...
//        bd_r[1]=force->numeric(FLERR,arg[4]);
        bd_l[0]=utils::numeric(FLERR,arg[1],false,lmp);
        bd_l[1]=utils::numeric(FLERR,arg[2],false,lmp);
        bd_r[0]=utils::numeric(FLERR,arg[3],false,lmp);
        bd_r[1]=utils::numeric(FLERR,arg[4],false,lmp);
